...
- Dans [java/gherkin](https://github.com/cucumber/cucumber/tree/master/gherkin/java/src/main/java/gherkin) puis [ast](https://github.com/cucumber/cucumber/tree/master/gherkin/java/src/main/java/gherkin/ast), vous trouverez une **implémentation java du langage Gherkin** conforme au diagramme de classes que vous venez de modéliser, diagramme de classes qui est également proposé dans le [README](https://github.com/cucumber/cucumber/blob/master/gherkin/README.md) du projet Gherkin : jetez un petit coup d'oeil par [là](https://github.com/cucumber/gherkin-java/tree/master/src/main/java/gherkin/ast), il faut descendre un peu pour l'apercevoir :simple_smile:
